...
# ---------------------------------------------------------------------------
# FILENAME, RADIUS, STARTCITY, ENDCITY = 'SampleCoordinates.txt', 0.08, 0, 5
# FILENAME, RADIUS, STARTCITY, ENDCITY = 'HungaryCities.txt', 0.005, 311, 702
FILENAME, RADIUS, STARTCITY, ENDCITY = 'GermanyCities.txt', 0.0025, 1573, 10584
